...
{
    public static async Task<List<T>> GetTableEntitiesByPrimaryKey<T>(this TableServiceClient tableServiceClient, string partitionKey, int pageSize = 20, IEnumerable<string>? select = null) where T : class, ITable
    {
    ...
    public static async Task<List<T>> GetTableEntitiesByPrimaryKey<T>(this TableClient tableClient, string partitionKey, int pageSize = 20, IEnumerable<string>? select = null) where T : class, ITable
    {
