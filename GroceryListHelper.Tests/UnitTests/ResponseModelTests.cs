...
public class ResponseModelTests
{
    ...
    public void Success2Response()
    {
        ...
        string result = response.Map(x => x, e => throw new Exception());
    ...
    public void Success2Error()
    {
        ...
        Assert.Throws<Exception>(() => response.Map(x => x, e => throw new Exception()));
    }
    ...
    public void Success3Response()
    {
        ...
        string result = response.Map(x => x, e => throw new Exception(), e => throw new Exception());
        Assert.Equal("X", result);
    }
    ...
    public void Success3Error1()
    {
        ...
        Assert.Throws<Exception>(() => response.Map(x => x, e => throw new Exception(), e => throw new Exception()));
    }
    ...
    {
        Result<string, NotFoundError> response = "X";
        string result = await response.MapAsync(x => Task.FromResult(x), e => throw new Exception());
        Assert.Equal("X", result);
    }
    ...
    public async Task Success2ErrorAsync()
    {
        ...
        await Assert.ThrowsAsync<Exception>(() => response.MapAsync(x => Task.FromResult(x), e => throw new Exception()));
    }
    ...
    {
        Result<string, NotFoundError, ForbiddenError> response = "X";
        string result = await response.MapAsync(x => Task.FromResult(x), e => throw new Exception(), e => throw new Exception());
        Assert.Equal("X", result);
    }
    ...
    {
        Result<string, NotFoundError, ForbiddenError> response = new(new NotFoundError());
        await Assert.ThrowsAsync<Exception>(() => response.MapAsync(x => Task.FromResult(x), e => throw new Exception(), e => throw new Exception()));
    }
